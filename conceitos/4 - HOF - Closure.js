...
console.log(aplicarOperacao({ numero1: 55, numero2: 3, operacao: somar }));

console.log(aplicarOperacao({ numero1: 55, numero2: 3, operacao: subtrair }));
